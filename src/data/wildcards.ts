...
export const wildcards: DataItem[] = [
  ...
  { id: "cupcake_machine", label: "Cupcake industrial complex", pack: "cool_kitchen", detail: "Own the giant cupcake machine and use it every day." },
  ...
  { id: "jail_cell", label: "Home jail cell", pack: "base", detail: "Build a working jail cell in the house. Who ends up in it is your business." },
